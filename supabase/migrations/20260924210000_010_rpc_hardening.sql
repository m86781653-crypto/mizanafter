...
REVOKE ALL ON FUNCTION public.mrx_capture_meter_reading(uuid,numeric,timestamptz,text,text,numeric,numeric,text,numeric,numeric,numeric,text,uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.mrx_capture_meter_reading(uuid,numeric,timestamptz,text,text,numeric,numeric,text,numeric,numeric,numeric,text,uuid) TO authenticated;
